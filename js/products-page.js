// Отваряне/затваряне на accordion секциите в сайдбара
...
function fillProductModal(p) {
  ...
  if (priceBgnEl) priceBgnEl.textContent = formatPrice(p.price_bgn) + " лв.";
  if (priceEurEl) priceEurEl.textContent = formatPrice(p.price_eur) + " €";
